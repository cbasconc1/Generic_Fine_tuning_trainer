...
class GestureRecognition:
    def __init__(self, keypoint_classifier_label, keypoint_classifier_model,
        ...
        # Load modelskeypoint_classifier_model
    ...
    def load_model(self):
        ...
        # Read labels
        with open(self.keypoint_classifier_label, #leen etiquetas jeje
    ...
    def recognize(self, image, flip ,number=-1, mode=0): # Ha sdo modificado, flip originalmnte no existía

        # TODO: Move constants to other place
        USE_BRECT = True

        image = cv.flip(image, flip)  # Mirror display
